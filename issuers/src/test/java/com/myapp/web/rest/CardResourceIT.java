...
import com.myapp.IssuersApp;
import com.myapp.domain.Card;
import com.myapp.repository.CardRepository;
 ...
 */
@SpringBootTest(classes = IssuersApp.class)
...
public class CardResourceIT {
    ...
    public void createCard() throws Exception {
        ...
        assertThat(testCard.getRoomNumber()).isEqualTo(DEFAULT_ROOM_NUMBER);
    }
    ...
    public void updateCard() throws Exception {
        ...
        assertThat(testCard.getRoomNumber()).isEqualTo(UPDATED_ROOM_NUMBER);
    }
