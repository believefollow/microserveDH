...
public class VipResourceIT {
    ...
    private static final LocalDate DEFAULT_SIGN_IN_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_SIGN_IN_DATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Vip createEntity(EntityManager em) {
        Vip vip = new Vip()
            ...
            .signInDate(DEFAULT_SIGN_IN_DATE);
        return vip;
    }
    /**
    ...
    public static Vip createUpdatedEntity(EntityManager em) {
        Vip vip = new Vip()
            ...
            .signInDate(UPDATED_SIGN_IN_DATE);
        return vip;
    }
    ...
    public void createVip() throws Exception {
        ...
        assertThat(testVip.getSignInDate()).isEqualTo(DEFAULT_SIGN_IN_DATE);
    }
    ...
    public void getAllVips() throws Exception {
        ...
        restVipMockMvc.perform(get("/api/vips?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].signInDate").value(hasItem(DEFAULT_SIGN_IN_DATE.toString())));
    }
    ...
    public void getVip() throws Exception {
        ...
        restVipMockMvc.perform(get("/api/vips/{id}", vip.getId()))
            ...
            .andExpect(jsonPath("$.signInDate").value(DEFAULT_SIGN_IN_DATE.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateVip() throws Exception {
        ...
        assertThat(testVip.getSignInDate()).isEqualTo(UPDATED_SIGN_IN_DATE);
    }
