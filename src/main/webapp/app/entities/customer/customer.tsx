            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('idCard')}>
                  Id Card <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('nation')}>
                  Nation <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('age')}>
                  Age <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('img')}>
                  Img <FontAwesomeIcon icon="sort" />
                </th>
                <th>
              ...
              {customerList.map((customer, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {customer.img ? (
                      <div>
                        {customer.imgContentType ? (
                          <a onClick={openFile(customer.imgContentType, customer.img)}>
                            <img src={`data:${customer.imgContentType};base64,${customer.img}`} style={{ maxHeight: '30px' }} />
                            &nbsp;
                          </a>
                        ) : null}
                        <span>
                          {customer.imgContentType}, {byteSize(customer.img)}
                        </span>
                      </div>
                    ) : null}
                  </td>
                  <td>{customer.checkIn ? <Link to={`check-in/${customer.checkIn.id}`}>{customer.checkIn.id}</Link> : ''}</td>
