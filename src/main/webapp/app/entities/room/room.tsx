              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('roomNumber')}>
                    Room Number <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('roomType')}>
                    Room Type <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('priceType')}>
              ...
              <tbody>
                {roomList.map((room, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{room.roomType}</td>
                    <td>{room.priceType}</td>
                    <td>{room.checkIn ? <Link to={`check-in/${room.checkIn.id}`}>{room.checkIn.id}</Link> : ''}</td>
