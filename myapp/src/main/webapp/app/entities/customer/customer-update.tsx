  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myappApp.customer.home.createOrEditLabel">
            <Translate contentKey="myappApp.customer.home.createOrEditLabel">Create or edit a Customer</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : customerEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="Male">{translate('myappApp.Sex.Male')}</option>
                  <option value="Female">{translate('myappApp.Sex.Female')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
