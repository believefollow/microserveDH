...
export const RoomDetail = (props: IRoomDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="myappApp.room.detail.title">Room</Translate> [<b>{roomEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{roomEntity.customer ? roomEntity.customer.id : ''}</dd>
          <dt>
            <Translate contentKey="myappApp.room.bill">Bill</Translate>
          </dt>
          <dd>{roomEntity.bill ? roomEntity.bill.id : ''}</dd>
        </dl>
